...
MEMBER_NAMES = {
    ...
    "CRM": "Salesforce", "NOW": "ServiceNow", "ADBE": "Adobe", "INTU": "Intuit",
    "WDAY": "Workday", "SNOW": "Snowflake", "DDOG": "Datadog", "MDB": "MongoDB",
    "TEAM": "Atlassian", "SHOP": "Shopify", "HUBS": "HubSpot", "TWLO": "Twilio",
    "GTLB": "GitLab", "PATH": "UiPath", "RDDT": "Reddit",
    ...
    "RDW": "Redwire", "PL": "Planet Labs", "FLY": "Firefly Aerospace", "SPCX": "SpaceX",
...
SUBJECTS = [
    ...
    {"id": "biotech", "label": "Biotechnology (basket)"},
    {"id": "consumerdisc", "label": "Consumer Discretionary (basket)"},
    {"id": "consumerstaples", "label": "Consumer Staples (basket)"},
...
_GROUPS = {
    ...
    "Theme baskets": ["gpu", "cpuasic", "memory", "semicap", "powersemi",
                      "photonics", "connectivity", "networking", "aiserver", "hyperscale",
                      "neocloud", "cdnedge", "software", "cyber", "biotech", "consumerdisc", "consumerstaples",
                      "elecind", "epc", "nuclear",
