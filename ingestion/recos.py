...
LEDGER = {
    "mycoverage": {
        ...
        "swaps": [
            ...
            ("2026-07-31", [("CNP", "GEV"), ("HUBB", "5802.T")]),
        ],
    },
    "fredcoverage": {
        "init": ("2026-01-09", ["ANET", "AVGO", "META", "MU", "NVDA"]),
        "swaps": [
            ("2026-01-30", [("NVDA", "WDC")]),
            ("2026-02-13", [("META", "NVDA")]),
            ("2026-03-27", [("WDC", "4062.T")]),
            ("2026-04-17", [("4062.T", "TER"), ("NVDA", "AMD")]),
            ("2026-04-30", [("ANET", "4062.T")]),
            ("2026-05-15", [("4062.T", "GOOGL")]),
            ("2026-05-29", [("AVGO", "ANET"), ("GOOGL", "6981.T"), ("TER", "4062.T")]),
            ("2026-06-05", [("MU", "NVDA")]),
            ("2026-06-18", [("ANET", "AVGO"), ("AMD", "8035.T"), ("NVDA", "MU")]),
            ("2026-07-24", [("4062.T", "AMAT")]),
            ("2026-07-31", [("8035.T", "6857.T"), ("AVGO", "4062.T")]),
        ],
    },
}
SLOTS = 5
